  ...
  if (stakeholder === "cfo") {
    return { ...common,
      ...
      paragraphs: [
        ...
        `Recommendation: validate utilization against SSO log-in data for the ten largest contracts first — they typically hold 60%+ of the waste — and sequence renegotiations to the renewal calendar.`
      ]
    };
  }
